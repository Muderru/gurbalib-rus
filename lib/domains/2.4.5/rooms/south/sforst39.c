...
void setup(void) {
   ...
   add_exit("север", DIR + "/rooms/south/sforst34.c");
   add_exit("юг", DIR + "/rooms/south/sforst43.c");
   add_exit("восток", DIR + "/rooms/south/sforst40.c");
   add_exit("запад", DIR + "/rooms/south/sforst38.c");
}
